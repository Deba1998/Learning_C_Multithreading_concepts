...
std::mutex pencil;
boost::latch fist_bump(5);  //have to decrease the value to zero after that the thread waiting at fist_bump.wait() will continue execution, no need to wait for other barron threads to arrive once the 5 olivia thread completes it can continue execution
